    ...
    <div className="min-h-screen">
      ...
      <section className="h-screen relative flex items-center justify-center hero-gradient overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <spline-viewer url="https://prod.spline.design/Z0CQFBxoyd7DfpQ8/scene.splinecode"></spline-viewer>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 text-center">
          ...
          <p className="text-xl md:text-2xl text-[#E5FFFC] mb-12 max-w-3xl mx-auto opacity-90 animate-slide-up">
      ...
      <section className="py-20 bg-[#050A0A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold gradient-text mb-4">Our Expertise</h2>
