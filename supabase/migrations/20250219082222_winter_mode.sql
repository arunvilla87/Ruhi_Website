/*
  ...
  1. Changes
    - Insert sample job listings with detailed descriptions, requirements, and responsibilities
    - Jobs are created with a default admin user ID (you'll need to replace this with your actual admin user ID)
*/
